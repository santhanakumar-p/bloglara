            ...
            @foreach ($posts as $post)
                <div class="post-card">
                    <div class="post-image">
                        <img src="uploads/{{ $post->image }}" alt="Laravel Tips">
                    </div>
                    <div class="post-content">
                        ...
                        <p class="post-excerpt">{{ Str::limit($post->content, 50) }}...</p>
                        <a href="{{ route('fullpost', ['id' => $post->id]) }}" class="read-more">Read More →</a>
                    </div>
                </div>
            @endforeach
        </div>
